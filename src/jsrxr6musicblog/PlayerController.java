...
public class PlayerController extends Switchable implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visualizers.add(new Jsrxr6CoolVisual());
    ...
    private void handleGoToWrite(){
        ...
        WriterController controller = (WriterController)getControllerByName("Writer");
        
        if(controller != null){
            if(!filePath.equals("")){
                controller.htmlEditor.setHtmlText("Write about: ".concat(filePath));
            } else {
                controller.htmlEditor.setHtmlText("Listen to a song and write about it here!");
            }
        }
    }
}
